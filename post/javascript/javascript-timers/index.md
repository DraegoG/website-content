...
date: 2018-03-31T07:04:59+02:00
...
When writing [JavaScript](https://flaviocopes.com/javascript/) code, you might want to delay the execution of a function.
...
`setTimeout` and `setInterval` are available in [Node.js](https://flaviocopes.com/nodejs/), through the [Timers module](https://nodejs.org/api/timers.html).
