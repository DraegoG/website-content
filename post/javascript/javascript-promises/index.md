...
Although they've been around for years, they were standardized and introduced in [ES2015](https://flaviocopes.com/es6/), and now they have been superseded in [ES2017](https://flaviocopes.com/es2017/) by [async functions](https://flaviocopes.com/javascript-async-await).
...
At this point, the caller function waits for it to either return the promise in a **resolved state**, or in a **rejected state**, but _the function continues its execution while the promise does it work_.
