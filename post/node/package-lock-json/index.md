...
date: 2018-08-05T07:00:00+02:00
tags: node
tags_weight: 11
path: package-json-lock
---

In version 5, [npm](https://flaviocopes.com/npm/) introduced the `package-lock.json` file.

What's that? You probably know about the [`package.json` file](https://flaviocopes.com/package-json/), which is much more common and has been around for much longer.
