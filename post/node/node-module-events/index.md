...
date: 2018-09-14T07:00:00+02:00
tags: node
tags_weight: 70
path: node-module-events
---

The `events` module provides us the EventEmitter class, which is key to working with events in Node.

[I published a full article on that](/node-event-emitter/), so here I will just describe the API without further examples on how to use it.
